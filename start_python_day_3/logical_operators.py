# Python এ তিন ধরনের logical operators আছে:
# 1. and (&&) - সব কন্ডিশন সত্য হতে হবে
# 2. or (||) - যেকোনো একটি কন্ডিশন সত্য হলেই হবে
# 3. not (!) - কন্ডিশন কে উল্টো করে দেয়
...
if age >= 18 and (has_learner_permit or has_driving_certificate):
    print("4. Eligible for driving license")
...
if (is_birthday or is_anniversary) and order_amount >= 1000:
    print("6. You get special discount")